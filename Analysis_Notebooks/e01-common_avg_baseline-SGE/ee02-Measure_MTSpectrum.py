...
path_ExpData = path_PeriphData + '/e01-MTSpectrum.CommonAverage.Baseline'
...
for win_ix in xrange(n_win):
    ...
    freq, psd = Echobase.Pipelines.ecog_powerspec.multiband(evData_mp[clip_ix, :], fs, avgref=True)
